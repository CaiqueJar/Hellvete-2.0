...
<body>
    <div class="quadrado">
        <div class="conteudo">
            <h1>Registro</h1>
            <hr>
            <form id="regForm" method="POST" action="<?php echo e(route('cadastrar')); ?>">
                <?php echo csrf_field(); ?>
                ...
                Já possui login? <a href="<?php echo e(route('login')); ?>">Entrar</a>
    ...
    <script src="<?php echo e(asset('js/teste.js')); ?>"></script> 

</body>
</html>


<?php /**PATH C:\Users\Admin\Downloads\outfit-store-main\resources\views/registro.blade.php ENDPATH**/ ?>