        ...
        <nav class="navbar navbar-expand-lg bg-custom">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                    <?php if($login): ?>
                        <li class="nav-item">
                            <a class="navbar-brand" href="<?php echo e(route('conta')); ?>">
...
</html><?php /**PATH /home/caique/Desktop/outfit-store-main/resources/views/layouts/clientes.blade.php ENDPATH**/ ?>