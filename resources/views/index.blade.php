    ...
    <div class="col-md-10">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="{{ asset('img/carousel-images/burzum-self-titled.png') }}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="{{ asset('img/carousel-images/darkthrone-transilvanian-hunger.png') }}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="{{ asset('img/carousel-images/mayhem-de-mysteris.png') }}" class="d-block w-100" alt="...">
                </div>
            </div>
